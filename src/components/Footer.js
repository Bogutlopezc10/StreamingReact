                    ...
                    <div className="container">
                        <div className="row d-flex social-network mt-2 mb-3 justify-content-center">
                            <div className="col-auto">
                                <a href="https://www.facebook.com/juancarlos.gonzalesmontes?ref=bookmarks" target="_blank">
                                    <i className="fab fa-facebook"></i>
                                </a>
                            </div>
                            <div className="col-auto">
                                <a href="https://twitter.com/juan9607" target="_blank">
                                    <i className="fab fa-twitter"></i>
                                </a>
                            </div>
                            <div className="col-auto">
                                <a href="https://github.com/Bogutlopezc10" target="_blank">
